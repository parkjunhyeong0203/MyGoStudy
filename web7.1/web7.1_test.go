...
func TestJsonHandler(t *testing.T) { //get test
	assert := assert.New(t)
...
func TestJsonHandler2(t *testing.T) { // get test
	assert := assert.New(t)
...
func TestJsonHandler3(t *testing.T) { // post test
	assert := assert.New(t)
